...
public class Survey3 extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myWebViewSurvey1 = (WebView) findViewById(R.id.webViewSurvey3);
		 //enable Javascript
		...
		//load URL of the website
		 ...
		 myWebViewSurvey1.loadUrl("http://160.16.101.96/~cedric-k/calorie/survey3.html");
