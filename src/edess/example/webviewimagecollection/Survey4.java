...
public class Survey4 extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myWebViewSurvey1 = (WebView) findViewById(R.id.webViewSurvey4);
		 //enable Javascript
		...
		//load URL of the website
		 ...
		 myWebViewSurvey1.loadUrl("http://160.16.101.96/~cedric-k/calorie/survey4.html");
